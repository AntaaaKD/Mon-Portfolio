    ...
    <section id="achievements" className="w-full py-24 bg-transparent text-white">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="relative">
          {/* LIGNE EN DÉGRADÉ */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-[3px] h-full bg-gradient-to-b from-[#7d1e68] via-[#c44eaa] to-transparent rounded-full opacity-50"></div>
