  ...
  return (
    <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4">
      <h1 className="text-6xl font-bold mb-4">
        Hi, I'm <span className="text-cyan-400">Anta DIOP</span>
      </h1>
      ...
      <div className="flex space-x-4">
        <a href="#projects" className="bg-text-cyan-400 text-lg px-6 py-3 rounded-full hover:bg-cyan-400 transition">
            View my Projects
        </a>
