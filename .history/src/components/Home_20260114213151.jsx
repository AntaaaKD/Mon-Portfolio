  ...
  return (
    <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4">
      ...
      <div className="flex space-x-4">
        <a href="#projects" className="bg-cyan-500 text-custom-blue px-6 py-3 rounded-full hover:bg-cyan-400 transition">View my Projests</a>
        <a href="/cv.pdf" download className="px-6 py-3 rounded-full border border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-custom-blue transition">Télécharger CV</a>
      </div>
    </section>
  );
};
