            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <a 
                  ...
                  className="w-full py-3 bg-[#0a192f] border border-[#eb5fe6]  text-[#7d1e68] text-sm font-bold rounded-xl flex items-center justify-center gap-3 hover:bg-cyan-500 hover:text-[#0a192f] hover:border-[#7d1e68] transition-all group/btn"
                >
