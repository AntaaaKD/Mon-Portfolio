  ...
  return (
    <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4">
      ...
      <div className="flex space-x-4">
        ...
        <a href="scr/cv.pdf" download className="px-6 py-3 rounded-full border border-cyan-500 text-lg hover:bg-cyan-500 hover:text-custom-blue transition">Download CV</a>
      </div>
    </section>
  );
};
