        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              ...
              What started as a creative hobbycrochet—evolved into a bespoke clothing business. This venture allows me to channel my creativity while managing an entrepreneurial project I truly love.
            </p>
