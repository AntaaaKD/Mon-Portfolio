...
const Home = () => {
  return (
    <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4">
      <h1 className="text-4xl font-bold"> Hi, I'm</h1><h1 className="text-6xl font-bold text-cyan-400 mb-4">Anta DIOP</h1>
      <h2 className="text-2xl font-bold text-cyan-300 mb-6">Passionné de Cybersécurité</h2>
