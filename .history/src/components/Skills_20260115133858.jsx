            ...
            <div key={idx} className="flex flex-col items-center">
              ...
              <div className="flex flex-wrap justify-center gap-6 w-full">
                {category.tools.map((tool, index) => (
                  <div 
                    key={index}
                    className="bg-[#112240] p-6 rounded-2xl border border-cyan-900/40 flex flex-col items-center justify-center w-40 h-40 transition-all duration-300 hover:border-[#7d1e68] hover:-translate-y-2 hover:shadow-[0_0_20px_rgba(34,211,238,0.15)] group"
                  >
