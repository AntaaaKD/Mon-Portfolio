...
const Projects = () => {
  const academicProjects = [
    ...
    },
    {
      ...
      tags: ["Cryptography", "Python", "WebSockets", "Pycharm"],
    ...
    <section id="projects" className="w-full py-24 bg-transparent text-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-[#7d1e68] uppercase tracking-tighter">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {academicProjects.map((project, index) => (
            <div 
              key={index} 
              className="w-full md:w-[calc(50%-2.5rem)] lg:w-[calc(33.333%-2.5rem)] bg-[#241140] rounded-2xl overflow-hidden border border-cyan-900/30 hover:border-[#7d1e68]/50 transition-all duration-300 shadow-xl group flex flex-col"
            >
              {/* Image */}
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#7d1e68] transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tags.map((tag, i) => (
                    <span key={i} className="text-[10px] font-mono text-[#40113e] bg-cyan-900/20 border border-cyan-800 px-2 py-1 rounded">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <a 
                  ...
                  className="w-full py-3 bg-[#0a192f] border border-cyan-800 text-[#7d1e68] text-sm font-bold rounded-xl flex items-center justify-center gap-3 hover:bg-cyan-500 hover:text-[#0a192f] hover:border-[#7d1e68] transition-all group/btn"
                >
