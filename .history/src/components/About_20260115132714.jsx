    ...
    <section id="about" className="py-20 px-4 bg-transparent text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-4xl font-bold text-center mb-16">
          About <span className="text-[#7d1e68]">Me</span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            <div className="absolute inset-0 rounded-full bg-[#7d1e68] opacity-20 blur-2xl animate-pulse"></div>
            <div className="relative w-full h-full rounded-full border-4 border-[#7d1e68] overflow-hidden shadow-[0_0_20px_rgba(34,211,238,0.5)]">
              <img 
                src="/image1.png" 
                alt="Anta DIOP" 
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              Alongside my engineering path, I founded <span className="text-[#7d1e68] font-bold"> Sa Muse: Awaken the muse within you</span>. 
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-40">
                <p className="text-[#7d1e68] font-bold text-xl">4+ years</p>
                <p className="text-xs text-gray-400">Experience</p>
              </div>
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-40">
                <p className="text-[#7d1e68] font-bold text-xl">7+ projects</p>
                <p className="text-xs text-gray-400">Completed</p>
              </div>
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-40">
                <p className="text-[#7d1e68] font-bold text-xl">Graduate</p>
