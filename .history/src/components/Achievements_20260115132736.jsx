        ...
        <div className="relative">
          ...
          {achievements.map((item, index) => (
            <div key={index} className={`relative flex items-center justify-between mb-24 w-full ${index % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
              ...
              {/* CARTE */}
              <div className="w-full md:w-5/12 ml-12 md:ml-0 bg-[#112240] p-8 rounded-2xl border border-cyan-900/50 hover:border-[#7d1e68]/50 transition-all duration-500 shadow-2xl group relative overflow-hidden">
                {item.isResearch && (
