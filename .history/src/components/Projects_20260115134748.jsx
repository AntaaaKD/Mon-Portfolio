      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {academicProjects.map((project, index) => (
            <div 
              key={index} 
              className="w-full md:w-[calc(50%-2.5rem)] lg:w-[calc(33.333%-2.5rem)] bg-[#112240] rounded-2xl overflow-hidden border border-cyan-900/30 hover:border-[#7d1e68]/50 transition-all duration-300 shadow-xl group flex flex-col"
            >
              {/* Image */}
