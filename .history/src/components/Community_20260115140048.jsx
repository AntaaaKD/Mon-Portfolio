...
const Community = () => {
  const experiences = [
    ...
    },
    {
      ...
      icon: <ShieldCheck className="text-[#7d1e68]" />,
    ...
    <section id="community" className="w-full py-24 bg-transparent text-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-[#7d1e68]  tracking-tighter">
            Community  <span className="text-white">Engagement</span>
            
          <div className="h-1 w-24 bg-gradient-to-r from-transparent via-[#7d1e68] to-transparent mx-auto mt-4 rounded-full"></div>
          </h2>
          <p className="text-gray-400 mt-4 italic">Active involvement in promoting technology, cybersecurity, and social impact within the Senegalese ecosystem.</p>
        </div>       
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {experiences.map((exp, index) => (
            <div 
              key={index} 
              className="bg-[#112240] p-8 rounded-2xl border border-cyan-900/30 hover:border-[#7d1e68]/50 transition-all duration-300 shadow-xl group"
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-white group-hover:text-[#7d1e68] transition-colors">
                    {exp.organization}
                  </h3>
                  <h4 className="text-[#903fab] font-medium mb-4 italic">
                    {exp.role}
                  </h4>
