...
const About = () => {
  return (
    <section id="about" className="py-20 px-4 bg-custom-lue text-white">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Cybersecurity Engineer passionate about analyzing, protecting, and detecting threats. 
              I specialize in designing secure infrastructures and exploring how AI can revolutionize 
              threat intelligence.
            </p>
