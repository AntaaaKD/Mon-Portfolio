    ...
    <>
      ...
      <div className={`fixed top-6 right-6 z-[60] transition-all duration-500 ${
        ...
        <button 
          ...
          className="w-14 h-14 bg-[#0a192f] text-[#0a192f] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(34,211,238,0.5)] hover:bg-white transition-all active:scale-90"
        >
