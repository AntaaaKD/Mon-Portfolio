  ...
  return (
    <section id="home" className="flex flex-col items-center justify-center h-screen text-center px-4">
      ...
      <div className="flex space-x-4">
        ...
        <a href="/cv.pdf" download className="bg-custom-blue bg-opacity-0 backdrop-blur-md text-custom-blue px-6 py-3 rounded-full hover:bg-cyan-400 transition">Télécharger CV</a>
      </div>
    </section>
  );
};
