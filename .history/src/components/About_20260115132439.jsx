        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-xl mb-4">
              Hello, I'm <span className font-bold">Anta DIOP</span>
            </h3>
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              Alongside my engineering path, I founded <span className font-bold"> Sa Muse: Awaken the muse within you</span>. 
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-40">
                <p className font-bold text-xl">7+ projects</p>
