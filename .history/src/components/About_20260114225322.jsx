        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              CI am a Cybersecurity Systems Engineer, graduated from the École Supérieure Polytechnique of Dakar.
              My journey began with a degree in Telecoms and Networks, leading me to specialize in IT Security. I am also deeply interested in Artificial Intelligence, especially its role in enhancing cybersecurity.
            </p>
            <p className="text-gray-300 mb-8 leading-relaxed">
              Beyond engineering, I am the **Founder of Sa Muse**, where I lead projects that 
              bridge technology and creativity. I am always looking for new challenges that 
              push the boundaries of digital safety.
            </p>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-32">
                <p className="text-cyan-400 font-bold text-xl">2+ years</p>
                <p className="text-xs text-gray-400">Experience</p>
              </div>
              <div className="bg-[#112240] p-4 rounded-xl border border-cyan-900 w-32">
                <p className="text-cyan-400 font-bold text-xl">10+ projects</p>
