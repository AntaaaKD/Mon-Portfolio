        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {contactLinks.map((contact, index) => (
            <a 
              ...
              className={`bg-[#112240] p-10 rounded-3xl border border-cyan-900/30 transition-all duration-300 group shadow-xl flex flex-col items-center hover:border-[#7d1e68]/50 hover:-translate-y-3`}
            >
